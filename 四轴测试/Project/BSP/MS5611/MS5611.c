...
uint32_t SETPressure;//启动气压定高时气压值
uint32_t TEMPSETPressure;//临时小范围高度值
uint32_t TEMP2,T2,OFF2,SENS2;	//温度校验值
u8 BARO_MODE;//0=没开气压定高，1=开启气压定高
uint32_t qidongdinggaoTHR;//启动气压定高时油门值
uint32_t OUT_THROTTLE;//启动气压定高时输出油门值
